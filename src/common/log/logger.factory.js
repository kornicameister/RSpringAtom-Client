      ...
      loggerCache[name] = (function () {
        ...
        return {
          log  : _.wrap(instance.log, function (fn) {
            logIfTrue.call(this, loggerLevels.LOG, fn, arguments);
          }),
          info : _.wrap(instance.info, function (fn) {
            logIfTrue.call(this, loggerLevels.INFO, fn, arguments);
          }),
          warn : _.wrap(instance.warn, function (fn) {
            logIfTrue.call(this, loggerLevels.WARN, fn, arguments);
          }),
          debug: _.wrap(instance.debug, function (fn) {
            logIfTrue.call(this, loggerLevels.DEBUG, fn, arguments);
          }),
          error: _.wrap(instance.error, function (fn) {
            logIfTrue.call(this, loggerLevels.ERROR, fn, arguments);
          })
        };
      }());
